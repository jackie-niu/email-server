...
// there is a bug here: when the message is empty, the substring returns -1, then +1 is added and so an empty string is returned
	...
	String subjectAndText = Globals.boxMessages[itemIndex].
	       substring(Globals.FIRST_RECORD_MARKER_POS + 1);
	       
	messageText = subjectAndText.
	substring(subjectAndText.indexOf(Globals.END_OF_SUBJECT_MARKER) + 1);
